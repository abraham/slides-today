Feature: Share decks
  ...
  Scenario: Share deck
    ...
    Then "https://twitter.com/i/flow/login?redirect_after_login=%2Fintent%2Ftweet%3Ftext%3DHow%2520Do%2520Service%2520Workers%2520Even%253F%2520http%253A%252F%252Flocalhost%253A5000%252Fdecks%252F-LP90xu1JfaAgTCyhC3D" should popup
    When I click on "Share"
    And I click on "Post"
